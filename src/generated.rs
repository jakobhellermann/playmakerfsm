...
pub struct PlayMakerFSM {
    ...
    pub m_Name: String,
    pub fsm: Fsm,
    pub fsmTemplate: TypedPPtr<FsmTemplate>,
...
pub struct Fsm {
    pub dataVersion: i32,
    pub usedInTemplate: TypedPPtr<FsmTemplate>,
    pub name: String,
...
pub struct FsmVariables {
    ...
    pub colorVariables: Vec<FsmColor>,
...
pub struct ActionData {
    ...
    pub fsmColorParams: Vec<FsmColor>,
...
pub struct FsmEventTarget {
    ...
    pub fsmComponent: TypedPPtr<PlayMakerFSM>,
}
